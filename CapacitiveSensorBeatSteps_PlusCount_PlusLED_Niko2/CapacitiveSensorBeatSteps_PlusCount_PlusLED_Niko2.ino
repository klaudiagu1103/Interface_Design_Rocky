...
void loop() {
  ...
  if (capacitorPressed (total_unten_rechts, &pressed_unten_rechts)) // Methode wird aufgerufen für Übergabe von total unten rechts und pressed unten rechts, wenn die funktion true zurückgibt ,erhöhe den counter
  {
    count++;
  }
