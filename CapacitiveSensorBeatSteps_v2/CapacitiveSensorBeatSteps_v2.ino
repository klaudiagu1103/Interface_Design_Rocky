...
CapacitiveSensor   cs_unten_rechts = CapacitiveSensor(16,5);       // 10M resistor between pins 4 & 2, pin 2 is sensor pin, add a wire and or foil if desired
CapacitiveSensor   cs_unten_links = CapacitiveSensor(16,4);
CapacitiveSensor   cs_oben_rechts = CapacitiveSensor(16,0);
CapacitiveSensor   cs_oben_links = CapacitiveSensor(16,2);
int count = 0;
int ledA = 13;
int ledB = 12;
int ledC = 11;
